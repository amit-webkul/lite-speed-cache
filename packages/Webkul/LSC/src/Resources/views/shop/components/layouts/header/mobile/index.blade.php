...
@pushOnce('scripts')
    ...
    <script
        type="text/x-template"
        id="v-login-mobile-dropdown-template"
    >
        <div>
    ...
    <script type="module">
        app.component('v-login-mobile-dropdown', {
            template: '#v-login-mobile-dropdown-template',
            ...
            mounted() {
                this.getLoginMobileContent();
            },

            methods: {
                getLoginMobileContent() {
                    this.$axios.get("{{ route('shop.api.home.login_mobile_dropdown') }}")
                        .then(response => {
                            this.$refs.lsc_mobile_container.innerHTML = response.data.data;
                        })
                        .catch(error => {
                            console.log(error);
                        });
            ...
            methods: {
                getLoginMobileDrawer() {
                    this.$axios.get("{{ route('shop.api.home.login_mobile_drawer') }}")
                        .then(response => {
                            this.$refs.lsc_mobile_drawer.innerHTML = response.data.data;
                        })
                        .catch(error => {
                            console.log(error);
                        });
