            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'Définissez le temps de vie par défaut des éléments mis en cache en secondes <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[Plus d\'infos]</a>.',
