            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'Establezca el tiempo de vida predeterminado para los elementos en caché en segundos <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[Más información]</a>.',
