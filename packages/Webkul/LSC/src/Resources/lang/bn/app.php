            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'ক্যাশ করা আইটেমগুলোর জন্য ডিফল্ট জীবনকাল (সেকেন্ডে) নির্ধারণ করুন <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[আরও তথ্য]</a>.',
