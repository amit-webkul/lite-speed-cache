            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'キャッシュ項目のデフォルトの存続時間（秒）を設定します。 <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[詳細]</a>.',
                        'guest-only'       => 'ゲストのみ',
