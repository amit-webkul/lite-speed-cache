            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'اضبط المدة الافتراضية لبقاء العناصر المخزنة مؤقتًا بالثواني <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[مزيد من المعلومات]</a>.',
