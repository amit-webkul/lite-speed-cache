            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'कॅश किए गए आइटमों के लिए डिफ़ॉल्ट जीवनकाल (सेकंड में) सेट करें <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[अधिक जानकारी]</a>.',
