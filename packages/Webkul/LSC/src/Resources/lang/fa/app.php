            ...
            'lsc' => [
                ...
                'configuration' => [
                    ...
                    'cache-application' => [
                        ...
                        'default-ttl-info' => 'زمان ماندگاری پیش‌فرض برای آیتم‌های کش‌شده را بر حسب ثانیه مشخص کنید <a class="text-blue-600" href="https://docs.litespeedtech.com/lscache/lsclaravel/settings/#cache-control" target="_blank">[اطلاعات بیشتر]</a>.',
